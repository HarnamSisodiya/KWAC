            ...
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              ...
              <SheetContent side="right" className="glass-card">
                <nav className="flex flex-col space-y-4 mt-8">
                  ...
                  <Link href="/about" className="nav-item" onClick={() => setIsMenuOpen(false)}>
                    About Us
                  </Link>
                  <Link href="/events" className="nav-item" onClick={() => setIsMenuOpen(false)}>
                    Events
                  </Link>
                  <Link href="/photos" className="nav-item" onClick={() => setIsMenuOpen(false)}>
                    Photos
                  </Link>
                  <Link href="/community-business" className="nav-item" onClick={() => setIsMenuOpen(false)}>
                    Community Business
                  </Link>
                  <Link href="/contact" className="nav-item" onClick={() => setIsMenuOpen(false)}>
                    Contact Us
                  </Link>
                  <Link href="/donate" className="nav-item" onClick={() => setIsMenuOpen(false)}>
                    Donate
                  </Link>
                </nav>
              </SheetContent>
